...
def main():
	image_url_dir = 'G:\\郑州轻工业大学\\论文\\BIBM2021\\MGID-dataset\\v3-final\\dev\\dev.csv' #the url data path
	data_label = "dev"
	i = 1
	target_path = 'G:\\郑州轻工业大学\\论文\\BIBM2021\\MGID-dataset\\image\\dev\\' # your download path
